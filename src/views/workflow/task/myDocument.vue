            ...
            <el-table-column label="操作" align="center" width="160" class-name="small-padding fixed-width">
              <template #default="scope">
                <el-row :gutter="10" class="mb8">
                  ...
                  <el-col :span="1.5" v-if="scope.row.businessStatus === 'draft' || scope.row.businessStatus === 'cancel' || scope.row.businessStatus === 'back'">
                  ...
                  <el-col :span="1.5" v-if="scope.row.businessStatus === 'waiting'">
                    <el-button type="text" size="small" icon="Notification" @click="handleCancelProcessApply(scope.row)">撤销</el-button>
                  </el-col>
                  <el-col :span="1.5" v-if="scope.row.businessStatus === 'draft' || scope.row.businessStatus === 'cancel' || scope.row.businessStatus === 'back'">
                    <el-button type="text" size="small" icon="Edit" @click="submitVerifyOpen(scope.row.taskVoList[0].id)">提交</el-button>
                  </el-col>
                </el-row>
              </template>
            </el-table-column>
